<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-gray-500">
            ...
            <span class="text-white">Nuevo movimiento</span>
        </div>
    </x-slot>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Nuevo movimiento</h1>
            <p class="text-sm text-gray-500 mt-0.5">Registra un ingreso o egreso de la empresa</p>
        </div>
    </div>

    <div class="max-w-2xl">
        <form method="POST" action="{{ route('ingresos-egresos.store') }}" enctype="multipart/form-data">
            @csrf

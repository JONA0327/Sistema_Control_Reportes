<x-app-layout>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('roles.permisos.edit') }}"
               class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-800/60 border border-gray-700/50 text-gray-300 text-sm font-semibold hover:bg-gray-700 hover:text-white transition-colors">

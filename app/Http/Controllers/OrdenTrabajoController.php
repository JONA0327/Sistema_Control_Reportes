...
class OrdenTrabajoController extends Controller
{
    public function show(Request $request, Report $report)
    {
        ...
        $report->load(['bus', 'operador', 'photos', 'partsUsed.item', 'partsUsed.installedBy']);
        ...
        return view('reports.orden', compact('report', 'orden', 'mecanicos', 'inventario'));
    }
    ...
    public function exportPdf(Report $report)
    {
        $orden = $report->ordenTrabajo()->firstOrFail();
        $orden->load('mecanico');
        $report->load(['bus', 'operador', 'photos', 'partsUsed.item']);

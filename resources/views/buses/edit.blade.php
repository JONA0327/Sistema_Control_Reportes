                ...
                <div class="px-6 py-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="num_asientos" name="num_asientos" value="{{ old('num_asientos', $bus->num_asientos) }}"
                                   class="w-full px-3.5 py-2.5 bg-gray-900/80 border {{ $errors->has('num_asientos') ? 'border-red-500' : 'border-gray-700' }} rounded-xl text-white text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors"
                                   min="1" max="100"/>
                ...
                <div class="px-6 py-5">
                    ...
                    @else
                        <select id="copiloto_id" name="copiloto_id"
                            ...
                            @foreach($operadores as $op)
                                <option value="{{ $op->id }}" class="bg-gray-900" {{ old('copiloto_id', $bus->copiloto_id) == $op->id ? 'selected' : '' }}>

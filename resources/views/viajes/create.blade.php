<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-gray-500">
            ...
            <span class="text-white">Nuevo viaje</span>
        </div>
    </x-slot>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Nuevo viaje</h1>
            <p class="text-sm text-gray-500 mt-0.5">Registra los datos principales del viaje</p>
        </div>
    </div>
    ...
    <div class="max-w-3xl">
        <form method="POST" action="{{ route('viajes.store') }}">
            @csrf
            @include('viajes._form', ['submitLabel' => 'Registrar viaje'])
        </form>
    </div>

<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-gray-500">
            ...
            <span class="text-white">Nueva unidad</span>
        </div>
    </x-slot>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Nueva unidad</h1>
            <p class="text-sm text-gray-500 mt-0.5">Registra un nuevo autobús en el sistema</p>
        </div>
    </div>
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="num_bus" name="num_bus" value="{{ old('num_bus') }}"
                                   class="w-full px-3.5 py-2.5 bg-gray-900/80 border {{ $errors->has('num_bus') ? 'border-red-500' : 'border-gray-700' }} rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" id="placa" name="placa" value="{{ old('placa') }}"
                                   class="w-full px-3.5 py-2.5 bg-gray-900/80 border {{ $errors->has('placa') ? 'border-red-500' : 'border-gray-700' }} rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors font-mono uppercase tracking-wider"
                                   placeholder="Ej: ABC-1234" maxlength="20"
                ...
                <div class="px-6 py-5">
                    ...
                    @if($operadores->isEmpty())
                        <div class="flex items-center gap-3 px-4 py-3 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                            ...
                            <p class="text-xs text-amber-300">No hay operadores activos disponibles. Crea un usuario con rol <strong>Operador</strong> primero.</p>
                        </div>
                    @else
                        <div class="grid grid-cols-1 gap-2 max-h-52 overflow-y-auto pr-1">
                            <label class="relative cursor-pointer">
                                <input type="radio" name="operator_id" value="" class="sr-only peer"
                                       {{ old('operator_id') === null ? 'checked' : '' }}>
